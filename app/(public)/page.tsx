...
const features:featureProps[] = [
    ...
    },
    {
        ...
        description: "Join a vibrant community of learners and instructors to collaborate and upskill",
        icon: "👥",
    }
]
        ...
        <section className="relative py-20">
            <div className="flex flex-col items-center text-center space-y-8">
                <Badge variant="outline">
                    Learn. Build. Apply. - SkillDev.
                </Badge>
                <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                    Elevate your Learning Experience
                </h1>
                <p className="max-w-[700px] text-muted-foreground">Discover a new way to learn with our modern, interactive learning management system.</p>
